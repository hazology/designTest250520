...
function switcherClick() {
    ...
    let backgroundColor1Var = bgDefaultColor1Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', "43, 52, 111");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'light');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "43, 52, 111");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(43, 52, 111)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(0,0,0,.1)");
        document.querySelector('html').style.setProperty('--sidemenu-active-bgcolor', "rgb(43, 52, 111)");
    ...
    let backgroundColor2Var = bgDefaultColor2Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', "32, 95, 128");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'light');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "32, 95, 128");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(32, 95, 128)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(0,0,0,.1)");
        document.querySelector('html').style.setProperty('--sidemenu-active-bgcolor', "rgb(32, 95, 128)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
        document.querySelector('#switcher-header-dark').checked = true
    })
    let backgroundColor3Var = bgDefaultColor3Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', "106, 58, 146");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'light');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "106, 58, 146");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(106, 58, 146)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(0,0,0,.1)");
        document.querySelector('html').style.setProperty('--sidemenu-active-bgcolor', "rgb(106, 58, 146)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
        document.querySelector('#switcher-header-dark').checked = true
    })
    let backgroundColor4Var = bgDefaultColor4Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', "46, 116, 71");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'light');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "46, 116, 71");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(46, 116, 71)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(0,0,0,.1)");
        document.querySelector('html').style.setProperty('--sidemenu-active-bgcolor', "rgb(46, 116, 71)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
        document.querySelector('#switcher-header-dark').checked = true
    })
    let backgroundColor5Var = bgDefaultColor5Btn.addEventListener('click', () => {
        ...
        localStorage.setItem('bodylightRGB', "133, 84, 43");
        html.setAttribute('data-theme-mode', 'dark');
        html.setAttribute('data-menu-styles', 'light');
        html.setAttribute('data-header-styles', 'dark');
        document.querySelector('html').style.setProperty('--body-bg-rgb', localStorage.bodyBgRGB);
        document.querySelector('html').style.setProperty('--light-rgb', "133, 84, 43");
        document.querySelector('html').style.setProperty('--form-control-bg', "rgb(133, 84, 43)");
        document.querySelector('html').style.setProperty('--input-border', "rgba(0,0,0,.1)");
        document.querySelector('html').style.setProperty('--sidemenu-active-bgcolor', "rgb(133, 84, 43)");
        document.querySelector('#switcher-dark-theme').checked = true;
        document.querySelector('#switcher-menu-dark').checked = true;
        document.querySelector('#switcher-header-dark').checked = true
    })
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("yscomHeader", 'light');
        // localStorage.setItem("yscomMenu", 'light');
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomfullwidth", true);
        localStorage.removeItem("yscomboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomboxed", true);
        localStorage.removeItem("yscomfullwidth");
        checkHoriMenu()
    });
    /* Boxed Layout End */
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomregular", true);
        localStorage.removeItem("yscomclassic");
        localStorage.removeItem("yscommodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomclassic", true);
        localStorage.removeItem("yscomregular");
        localStorage.removeItem("yscommodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("yscommodern", true);
        localStorage.removeItem("yscomregular");
        localStorage.removeItem("yscomclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscomheaderfixed", true);
        localStorage.removeItem("yscomheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("yscomheaderscrollable", true);
        localStorage.removeItem("yscomheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("yscommenufixed", true);
        localStorage.removeItem("yscommenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("yscommenuscrollable", true);
        localStorage.removeItem("yscommenufixed");
    });
    ...
    let defaultVar = defaultBtn.addEventListener('click', () => {
        ...
        toggleSidemenu();
        /* removing default li active and ul*/
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("yscomverticalstyles", 'closed');
    });
    /* Closed Sidemenu End */
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("yscomverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("yscomverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("yscomverticalstyles", 'overlay');
    });
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("yscomverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("yscomnavstyles", 'menu-click');
        localStorage.removeItem("yscomverticalstyles");
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("yscomnavstyles", 'menu-hover');
        localStorage.removeItem("yscomverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("yscomnavstyles", 'icon-click');
        localStorage.removeItem("yscomverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("yscomnavstyles", 'icon-hover');
        localStorage.removeItem("yscomverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("yscomlayout");
        localStorage.setItem("yscomverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("yscomlayout", 'horizontal');
        localStorage.removeItem("yscomverticalstyles");
    ...
    let rtlVar = rtlBtn.addEventListener('click', () => {
        localStorage.setItem("yscomrtl", true);
        localStorage.removeItem("yscomltr");
        rtlFn(); 
    ...
    let ltrVar = ltrBtn.addEventListener('click', () => {
        //    local storage
        localStorage.setItem("yscomltr", true);
        localStorage.removeItem("yscomrtl");
        ltrFn();
        if (document.querySelector(".noUi-target")) {
            document.querySelectorAll(".noUi-origin").forEach((e) => {
...
function lightFn() {
    ...
    localStorage.removeItem("yscombgColor");
    localStorage.removeItem("yscomheaderbg");
    localStorage.removeItem("yscombgwhite");
    localStorage.removeItem("yscommenubg");
    localStorage.removeItem("yscommenubg");
    checkOptions();
...
function darkFn() {
    ...
    document.querySelector('html').style.removeProperty('--sidemenu-active-bgcolor');
    updateColors()
    localStorage.setItem("yscomdarktheme", true);
    localStorage.removeItem("yscomlighttheme");
    localStorage.removeItem("bodyBgRGB");
    localStorage.removeItem("yscombgColor");
    localStorage.removeItem("yscomheaderbg");
    localStorage.removeItem("yscombgwhite");
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('yscomHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('yscomHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('yscomHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('yscomHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('yscomHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('yscomMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('yscomMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('yscomMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('yscomMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('yscomMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('yscomboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('yscomheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('yscommenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('yscomheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('yscommenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('yscomclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('yscommodern')) {
...
function updateColors() {
    ...
    if (document.querySelector("#website-design") !== null) {
        websiteDesign();
    }
    if (document.querySelector("#project") !== null) {
        project();
    }
    if (document.querySelector("#revenue-chart") !== null) {
        revenueChart();
    }
    if (document.querySelector("#recentorders") !== null) {
        recentorders();
    }
    if (document.querySelector("#chart-bitcoin") !== null) {
        chartBitcoin();
    }
    if (document.querySelector("#chart-bitcoin1") !== null) {
        chartBitcoin1();
    }
    if (document.querySelector("#chart-bitcoin2") !== null) {
        chartBitcoin2();
    }
    ...
    if (document.querySelector("#todaytask") !== null) {
        todaytask();
    }
    if (document.querySelector("#ongoingprojects") !== null) {
        ongoingprojects();
    }
    if (document.querySelector("#ongoingprojects2") !== null) {
        ongoingprojects2();
    }
    if (document.querySelector("#websitedesign") !== null) {
        websitedesign();
    }
    if (document.querySelector("#bitcoin") !== null) {
        bitcoin();
    }
    if (document.querySelector("#yourprofile") !== null) {
        yourprofile();
    }
    ...
    if (document.querySelector("#btcmarket") !== null) {
        btcmarket();
    }
    if (document.querySelector("#ethmarket") !== null) {
        ethmarket();
    }
    if (document.querySelector("#xrpmarket") !== null) {
        xrpmarket();
    }
    if (document.querySelector("#ltcmarket") !== null) {
        ltcmarket();
    }
    if (document.querySelector("#bitcoinchart") !== null) {
        bitcoinchart();
    }
    if (document.querySelector("#ethereumchart") !== null) {
        ethereumchart();
    }
    if (document.querySelector("#ripplechart") !== null) {
        ripplechart();
    }
    if (document.querySelector("#dashchart") !== null) {
        dashchart();
    }
    if (document.querySelector("#neochart") !== null) {
        neochart();
    }
    if (document.querySelector("#litecoinchart") !== null) {
        litecoinchart();
    }
}
updateColors()
