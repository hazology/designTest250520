...
function switcherClick() {
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("yscomlandingHeader", 'light');
        localStorage.setItem("yscomlandingMenu", 'light');
    })
    /* Light Layout End */
    ...
    let darkThemeVar = darkBtn.addEventListener('click', () => {
        darkFn();
        localStorage.setItem("yscomlandingMenu", 'dark');
        localStorage.setItem("yscomlandingHeader", 'dark');
    });
    /* Dark Layout End */
    ...
    let rtlVar = rtlBtn.addEventListener('click', () => {
        localStorage.setItem("yscomlandingrtl", true);
        localStorage.removeItem("yscomlandingltr");
            rtlFn();
    });
    /* rtl end */
    ...
    let ltrVar = ltrBtn.addEventListener('click', () => {
        //    local storage
        localStorage.setItem("yscomlandingltr", true);
        localStorage.removeItem("yscomlandingrtl");
        ltrFn();
    });
    /* ltr end */
...
if(localStorage.yscomlandingrtl){
    rtlFn()
}
...
function lightFn() {
    ...
    updateColors()
    localStorage.removeItem("yscomlandingdarktheme");
    checkOptions();
    html.style.removeProperty('--primary-rgb');
}
...
function darkFn() {
    ...
    updateColors()
    localStorage.setItem("yscomlandingdarktheme", true);
    localStorage.removeItem("yscomlandinglighttheme");
    checkOptions();
    html.style.removeProperty("--primary-rgb");
}
...
function checkOptions() {
    ...
    // dark
    if (localStorage.getItem('yscomlandingdarktheme')) {
        document.querySelector('#switcher-dark-theme').checked = true;
    }

    //RTL
    if (localStorage.getItem('yscomlandingrtl')) {
...
function localStorageBackup() {
    ...
    if (localStorage.yscomlandingdarktheme) {
        let html = document.querySelector('html');
        html.setAttribute('data-theme-mode', 'dark');
    }
    ...
    if (localStorage.yscomlayout) {
        let html = document.querySelector('html');
        let layoutValue = localStorage.getItem('yscomlayout');
