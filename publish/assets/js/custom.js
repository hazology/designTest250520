(function () {
  ...
  function toggleTheme() {
    ...
    if (html.getAttribute("data-theme-mode") === "dark") {
      ...
      document
        .querySelector("html")
        .style.removeProperty("--input-border", localStorage.bodyBgRGB);
      document
        .querySelector("html")
        .style.removeProperty("--light-rgb", localStorage.bodyBgRGB);
      document
        .querySelector("html")
        .style.removeProperty("--sidemenu-active-bgcolor", localStorage.bodyBgRGB);
      checkOptions();
      ...
      localStorage.removeItem("yscomdarktheme");
      localStorage.removeItem("yscomMenu");
      localStorage.removeItem("yscomHeader");
      ...
      document.querySelector("#switcher-background1").checked = false;
      document.querySelector("#switcher-background").checked = false;
      localStorage.setItem("yscomdarktheme", "true");
      localStorage.setItem("yscomMenu", "dark");
      localStorage.setItem("yscomHeader", "dark");
      localStorage.removeItem("bodylightRGB");
      localStorage.removeItem("bodyBgRGB");
    }
  }
